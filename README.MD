...
> $Pl(\mathcal{A}) = \sum_{\mathcal{A} \cap \mathcal{B}}m(\mathcal{B}) \quad \forall \mathcal{A} \subseteq {\Theta}$.
...
Given two sets of masses $m_1$ and $m_2$,  the combination (called the **joint mass**) $$
